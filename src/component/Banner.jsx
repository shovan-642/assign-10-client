...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full h-full">
    <img 
      ...
      <div className='absolute top-8 left-[80px] md:left-[100px] lg:left-[500px] lg:top-[150px] flex flex-col gap-3'>
        <h1 className=' text-white font-bold text-5xl text-center'>Unlimited movies,<br /> TV shows, and more</h1>
        <p className='text-white text-2xl hidden lg:block font-bold  '>Starts at USD 9.99. Cancel anytime.</p>
      </div>
  ...
  <div id="slide2" className="carousel-item relative w-full h-full">
    <img
      ...
      <div className='absolute top-8 left-[80px] md:left-[100px] lg:left-[100] lg:top-[150px] flex flex-col gap-3'>
        ...
        <p className='text-white text-base hidden lg:block font-bold  '>Journey into the cosmic depths of the mighty Cineflix Universe!</p>
      </div>
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
  ...
  <div id="slide3" className="carousel-item relative w-full h-full">
    <img
      ...
      className="w-full object-cover" />
            <div className='absolute top-8 left-[80px] md:left-[100px] lg:left-[100] lg:top-[150px] flex flex-col gap-3'>
        <h1 className=' text-white font-bold text-5xl text-center'>CineFlix Rivals Official Launch Date</h1>
        <p className='text-white text-2xl hidden lg:block font-bold  '>The Intergalactic Empire of Wakanda is in danger!</p>
      </div>
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide2" className="btn btn-circle bg-red-600">❮</a>
      <a href="#slide1" className="btn btn-circle bg-red-600">❯</a>
