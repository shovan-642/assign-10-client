...
const UpdateMovie = () => {
  ...
  return (
    <div className="w-full mx-auto bg-black text-white">
      ...
      <form className="flex flex-col  gap-5" onSubmit={handleUpdateMovie}>
        <div>
        ...
        <div>
          ...
          <select defaultValue={genre} name="genre" className="select" required>
        ...
        <button className="btn btn-ghost bg-red-600">Update Movie</button>
      </form>
      </div>
